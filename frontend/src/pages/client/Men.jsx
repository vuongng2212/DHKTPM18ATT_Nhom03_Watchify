...
const MenPage = () => {
  ...
  }, [currentPage, selectedBrands, priceRange, sortBy, sortDirection, brandSlug, menCategoryId]);
  ...
  const fetchMenCategory = async () => {
    try {
      ...
      const menCategory = mainCategories.find(cat => cat.slug === 'dong-ho-nam');
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      // Filter by Men category using categoryId
      if (menCategoryId) {
        params.categoryId = menCategoryId;
      }
